package com.iqonic.learnerapp.base

import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.iqonic.learnerapp.utils.inflate

class LearnerRecyclerViewAdapter<T>(private val layout: Int, val onBind: (view: View, item: T, position: Int) -> Unit) : RecyclerView.Adapter<LearnerRecyclerViewAdapter<T>.ViewHolder<T>>() {
