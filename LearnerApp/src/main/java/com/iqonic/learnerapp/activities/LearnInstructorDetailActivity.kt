...
import kotlinx.android.synthetic.main.learn_activity_instructor_detail.*
import kotlinx.android.synthetic.main.learn_content_instructor_detail.*
import kotlinx.android.synthetic.main.learn_item_favourite_course.view.*
import java.util.*
import kotlin.collections.ArrayList

class LearnInstructorDetailActivity : LearnerBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.learn_activity_instructor_detail)
        rvFavourites.apply {
            setVerticalLayout()
