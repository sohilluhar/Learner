package com.iqonic.learnerapp.utils

import android.content.Context
import android.content.SharedPreferences
import com.iqonic.learnerapp.LearnerApp.Companion.getAppInstance
import com.iqonic.learnerapp.R

class LearnerAppSharedPrefUtils {
    private val mSharedPreferences: SharedPreferences = getAppInstance().getSharedPreferences(getAppInstance().getString(R.string.learn_pref_name), Context.MODE_PRIVATE)
